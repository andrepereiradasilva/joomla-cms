...
class JText
{
	...
	public static function _($string, $jsSafe = false, $interpretBackSlashes = true, $script = false)
	{
		...
		static::$strings[$string] = JFactory::getLanguage()->_($string, $jsSafe, $interpretBackSlashes);

		return $script ? $string : static::$strings[$string];
	}
	...
	{
		// Check if string contains a comma and a percentage sign
		...
		{
			$stringParts[$i] = JFactory::getLanguage()->_($str, $jsSafe, $interpretBackSlashes);
		}
