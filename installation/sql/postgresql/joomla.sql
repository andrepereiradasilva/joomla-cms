...
CREATE TABLE "#__assets" (
  ...
  "rules" varchar(5120) DEFAULT '' NOT NULL,
  PRIMARY KEY ("id"),
...
CREATE TABLE "#__contact_details" (
  ...
  "sortname1" varchar(255) DEFAULT '' NOT NULL,
  "sortname2" varchar(255) DEFAULT '' NOT NULL,
  "sortname3" varchar(255) DEFAULT '' NOT NULL,
  "language" varchar(7) DEFAULT '' NOT NULL,
  "created" timestamp without time zone DEFAULT '1970-01-01 00:00:00' NOT NULL,
...
CREATE TABLE "#__contentitem_tag_map" (
  "type_alias" varchar(255) NOT NULL DEFAULT '',
  "core_content_id" integer DEFAULT 0 NOT NULL,
...
CREATE TABLE "#__extensions" (
  ...
  "element" varchar(100) DEFAULT '' NOT NULL,
  ...
  "manifest_cache" text DEFAULT '' NOT NULL,
  "params" text DEFAULT '' NOT NULL,
