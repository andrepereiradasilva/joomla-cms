...
CREATE TABLE IF NOT EXISTS `#__assets` (
  ...
  `level` int(10) unsigned NOT NULL DEFAULT 1 COMMENT 'The cached level in the nested tree.',
  `name` varchar(50) NOT NULL DEFAULT '' COMMENT 'The unique name for the asset.\n',
  `title` varchar(100) NOT NULL DEFAULT '' COMMENT 'The descriptive title for the asset.',
  `rules` varchar(5120) NOT NULL DEFAULT '' COMMENT 'JSON encoded access control.',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `#__associations` (
  ...
  `key` char(32) NOT NULL DEFAULT '' COMMENT 'The key for the association computed from an md5 on associated ids.',
...
CREATE TABLE IF NOT EXISTS `#__banners` (
  ...
  `custombannercode` varchar(2048) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `#__contentitem_tag_map` (
  ...
  `core_content_id` int(10) unsigned NOT NULL DEFAULT 0 COMMENT 'PK from the core content table',
  `content_item_id` int(11) NOT NULL DEFAULT 0 COMMENT 'PK from the content type table',
  `tag_id` int(10) unsigned NOT NULL DEFAULT 0 COMMENT 'PK from the tag table',
  `tag_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Date of most recent save for this tag-item',
  `type_id` mediumint(8) NOT NULL DEFAULT 0 COMMENT 'PK from the content_type table',
