...
CREATE TABLE IF NOT EXISTS `#__update_sites` (
  ...
  `extra_query` varchar(1000) DEFAULT '',
  `protected` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'Flag to indicate if the update site is protected. Protected update sites cannot be disabled.',
  `failed_attempts` int(11) NOT NULL DEFAULT 0  COMMENT 'Counter with failed update sites connection attempts.',
...
INSERT INTO `#__update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `protected`, `failed_attempts`) VALUES
(1, 'Joomla! Core', 'collection', 'https://update.joomla.org/core/list.xml', 1, 0, 1, 0),
(2, 'Joomla! Extension Directory', 'collection', 'https://update.joomla.org/jed/list.xml', 1, 0, 1, 0),
(3, 'Accredited Joomla! Translations', 'collection', 'https://update.joomla.org/language/translationlist_3.xml', 1, 0, 1, 0),
(4, 'Joomla! Update Component Update Site', 'extension', 'https://update.joomla.org/core/extensions/com_joomlaupdate.xml', 1, 0, 1, 0);
